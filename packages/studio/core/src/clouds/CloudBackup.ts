...
export namespace CloudBackup {
    export const backup = async (cloudAuthManager: CloudAuthManager, service: Service) => {
        ...
        try {
            ...
            await CloudBackup.backupWithHandler(handler, progressValue, notification)
    ...
    export const backupWithHandler = async (cloudHandler: CloudHandler,
                                            progressValue: MutableObservableValue<unitValue>,
                                            notification: RuntimeNotification.ProgressUpdater) => {
