...
export type NoteSignalOn = { type: "note-on", uuid: UUID.Format, pitch: byte, velocity: unitValue }
...
export namespace NoteSignal {
    ...
    export const off = (uuid: UUID.Format, pitch: byte): NoteSignalOff =>
    ...
    export const fromEvent = (event: MIDIMessageEvent, uuid: UUID.Format): NoteSignal => {
